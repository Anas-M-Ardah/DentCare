...
const mockdata = [
    ...
    },
    {
      ...
      image:"../images/dr.fatima-mohammed.jpg"
    },
    {
      ...
      image: "../images/dr.mohammad-abdullah.jpg"
    },
      ...
      return `
        <div class="items">
          ...
          <div class="about-container">
            ...
            <h4 class="experience_h4">
              <span class="doctor-expenience">${el.experience}</span>+ years of
              experience | Speaks :
              <span class="languages">${el.language}</span>
            </h4>
            <p class="location-info"><b>Location:</b> ${el.location}</p>
          </div>
          <div class="appointment-container">
            <p class="charges-info">
