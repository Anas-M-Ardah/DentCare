...
const mockdata = [
    {
      name: "John Doe",
      qualification: "Date: 12/9/2023",
      experience: "Times Visited: 2",
      language: "",
      charge: 50,
      location: "29/8/2023",
    ...
    {
      name: "Ali Ahmed",
      qualification: "Date: 1/7/2023",
      experience: "Times Visited: 1",
      language: "",
      charge: 60,
      location: "15/6/2023",
      image: "../images/dr.ali-ahmed.jpg"
    },
      ...
      return `
        <div class="items">
          <div class="img-container">
            <img class="doc_img" style="width: 150px; height: 150px; border-radius: 50%;" src=${el.image} alt="img" />
          </div>
          <div class="about-container">
            <h3 class="about-title">${el.name}</h3>
            <ul class="qualification-list">
              <li>${qualificationArr[0]}</li>
              <li>${qualificationArr[1] ? qualificationArr[1] : " "}</li>
            </ul>
            <h4 class="experience_h4">
              <span class="doctor-expenience">${el.experience}</span>
              <span class="languages">${el.language}</span>
            </h4>
            <p class="location-info"><b>Last Visit:</b> ${el.location}</p>
          </div>
          <div class="appointment-container">
            <p class="charges-info">
              <b> $<span id="doctor-charges">${el.charge}</span> </b>
              per consultation
            </p>
